...
Author:
    ...
    Soundarya Soundarresan <soundaryas278@gmail.com>
"""
...
# %%
class EncodeQMRI(nn.Module):
    """
    Encode Network: From contrast-weighted images to quantitatve MRI parameters.
    """
    def __init__(self,
                 input_features: int = 81,
        ...
        super(EncodeQMRI, self).__init__()
...
# %%
def loss_function_bce(recon, orig, mu=None, logvar=None):
    """
    ...
    """
    BCE = F.binary_cross_entropy(recon, orig, reduction='sum')
